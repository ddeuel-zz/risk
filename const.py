...
{"territory" : BRAZIL, "neighbors" : [VENEZUELA,PERU,ARGENTINA,NORTH_AFRICA]},
{"territory" : ARGENTINA, "neighbors" : [PERU,BRAZIL]},
{"territory" : NORTH_AFRICA, "neighbors" : [BRAZIL,EGYPT,WESTERN_EUROPE,CONGO,EAST_AFRICA, BRAZIL]},
...
{"territory" : SCANDINAVIA, "neighbors" : [EASTERN_EUROPE,BRITAIN,NORTHERN_EUROPE,ICELAND]},
...
{"territory" : SOUTHERN_EUROPE, "neighbors" : [NORTHERN_EUROPE,MIDDLE_EAST,WESTERN_EUROPE,EGYPT,EASTERN_EUROPE]},
...
{"territory" : MONGOLIA, "neighbors" : [CHINA,JAPAN,KAMCHATKA,IRKUSTK,SIBERIA]},
...
# UNCOMMENT ALL LINES FOR MULTIPLAYER AND REMOVE END BRACKET ON LINE 145
